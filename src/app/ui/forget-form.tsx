    ...
    <form>
      <div className="bg-[#1A4870] md:h-screen md:w-screen">
        ...
        <div className=" flex-1 absolute place-content-center bg-[#f8f8ff] inset-y-0 left-10 pt-50 pl-10 w-1/3 h-4/5 top-10  right-1/3 rounded-lg">
          <div >
            <h1 className={`${poppins.className} mb-3 font-bold text-5xl`} >Forget Password?</h1>
            <p className="text-lg my-9">Enter your email address associate with your account. <br />We've sent a OTP to your email <br />Kindly Change your email</p>
          </div>
          <div>
            <div>
          ...
          <div>
            <Button className="mt-3 mb-3 h-14 text-lg">Request password reset</Button>
          </div>
          <div>
          </div>
        </div>
